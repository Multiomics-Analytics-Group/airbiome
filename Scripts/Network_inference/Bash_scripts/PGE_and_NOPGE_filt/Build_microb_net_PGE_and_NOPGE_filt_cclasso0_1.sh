...
#BSUB -q hpc
### -- set the job Name -- 
#BSUB -J cclasso0_1_PGE_and_NOPGE__filt_MAN
...
#BSUB -o /work3/asaru/Airbiome_project/Bash_scripts/PGE_and_NOPGE_filt/log/Output_%J.out 
#BSUB -e /work3/asaru/Airbiome_project/Bash_scripts/PGE_and_NOPGE_filt/log/Output_%J.err 
...
### Run script
Rscript ${PROJECT_DIR}/Build_microb_nets_based_on_groups.R --threshold 0.1 --network cclasso --biome PGE_and_NOPGE