...
#BSUB -o /work3/asaru/Airbiome_project/Bash_scripts/NO_PGE/log/Output_%J.out 
#BSUB -e /work3/asaru/Airbiome_project/Bash_scripts/NO_PGE/log/Output_%J.err 
...
### Run script
Rscript ${PROJECT_DIR}/Build_microb_net.R --threshold 0.1 --network cclasso --biome NO_PGE