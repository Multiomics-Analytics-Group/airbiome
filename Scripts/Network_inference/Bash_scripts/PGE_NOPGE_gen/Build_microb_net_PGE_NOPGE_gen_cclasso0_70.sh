...
#BSUB -q hpc
### -- set the job Name -- 
#BSUB -J cclasso0_70_PGE_NOPGE_gen_MAN
...
#BSUB -o /work3/asaru/Airbiome_project/Bash_scripts/PGE_NOPGE_gen/log/Output_%J.out 
#BSUB -e /work3/asaru/Airbiome_project/Bash_scripts/PGE_NOPGE_gen/log/Output_%J.err 
...
### Run script
Rscript ${PROJECT_DIR}/Build_microb_net.R --threshold 0.7 --network cclasso --biome PGE_NOPGE_gen
