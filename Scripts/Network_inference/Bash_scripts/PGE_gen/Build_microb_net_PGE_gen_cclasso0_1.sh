...
#BSUB -o /work3/asaru/Airbiome_project/Bash_scripts/PGE_gen/log/Output_%J.out 
#BSUB -e /work3/asaru/Airbiome_project/Bash_scripts/PGE_gen/log/Output_%J.err 
...
### Run script
Rscript ${PROJECT_DIR}/Build_microb_net_sp_gen.R --threshold 0.1 --network cclasso --biome PGE_gen